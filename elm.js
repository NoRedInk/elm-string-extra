...
Elm.String = Elm.String || {};
Elm.String.Extra = Elm.String.Extra || {};
Elm.String.Extra.make = function (_elm) {
   "use strict";
   _elm.String = _elm.String || {};
   _elm.String.Extra = _elm.String.Extra || {};
   if (_elm.String.Extra.values)
   return _elm.String.Extra.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "String.Extra",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var pluralize = F3(function (singular,
   plural,
   count) {
      return _U.eq(count,
      1) ? A2($Basics._op["++"],
      "1 ",
      singular) : A2($Basics._op["++"],
      $Basics.toString(count),
      A2($Basics._op["++"],
      " ",
      plural));
   });
   _elm.String.Extra.values = {_op: _op
                              ,pluralize: pluralize};
   return _elm.String.Extra.values;
};
Elm.Task = Elm.Task || {};
